...
// each built-in bullet library's own catalog.js (see
// bullets/bullet-libraries.js): a plain id list kept as a real ES module
// (not JSON) so both the app (rifles.js) and the module-type service
