...
Azzerare un fucile, in sostanza, significa regolare l'ottica sull'angolo che manda il proiettile al punto di mira a una distanza precisa — la distanza di azzeramento. Ogni altra correzione di mira, a ogni altra distanza, viene poi calcolata rispetto a quello stesso angolo di zero. Quell'angolo dipende naturalmente dalla cartuccia e dal proiettile in questione: più velocemente un proiettile raggiunge la distanza di azzeramento, più piccolo deve essere l'angolo. Se poi spari una cartuccia diversa senza cambiare nulla nello zero, i calcoli di traiettoria per quella cartuccia risulteranno sbagliati — esattamente nella misura in cui la balistica delle due cartucce differisce realmente alla distanza di azzeramento. Il caso classico: azzeri il fucile con munizioni surplus o da allenamento economiche, poi carichi una cartuccia premium da caccia o di servizio il cui punto d'impatto reale, a qualunque distanza, è spostato rispetto a quello che avrebbe dato il suo proprio zero indipendente.
