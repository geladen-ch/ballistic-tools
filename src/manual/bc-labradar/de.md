...
Es gibt einen ehrlichen Unfall, der aus dem Original erhalten blieb: Die Abbruchbedingung wird *nach* dem Herausschneiden geprüft, sodass die Schleife einen Punkt über den Boden hinaus entfernen kann und typischerweise auch tut und bei neun statt bei zehn landet. Sie bleibt, weil die Portierung zu dem Zeitpunkt, als der Fehler bemerkt wurde, bereits als Ganzes am Korpus echter Tracks validiert war und eine Änderung diese Validierung ohne bekannten Gewinn entwerten würde. Außerdem gibt es keine besondere Rechtfertigung für die Zahl 10; sie wurde als „vernünftiger Boden, der trotzdem Sinn ergibt“ gewählt, also warum nicht 9.
