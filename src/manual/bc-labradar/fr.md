...
Il subsiste un accident honnête hérité de l'original : la condition d'arrêt est vérifiée *après* le retrait, si bien que la boucle peut retirer, et retire typiquement, un point de plus que le plancher, s'arrêtant à neuf plutôt qu'à dix. Il est conservé parce qu'au moment où l'anomalie a été remarquée, le portage avait déjà été validé sur l'ensemble du corpus de pistes réelles, et que le modifier invaliderait cette validation sans gain connu. De plus, il n'y a pas de justification particulière derrière le nombre 10 ; il a été choisi comme un « plancher raisonnable, qui reste sensé », alors pourquoi pas 9.
