...
export const CACHE_VERSION = 'v198';
export const RELEASE_ID = '3.6.16';
export const CODENAME_SHORT = 'SMARTASS';
export const CODENAME_LONG = 'System of Modeling & Analytics for Range, Trajectory, Accuracy & Shot Success';
