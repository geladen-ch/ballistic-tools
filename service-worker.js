...
const APP_SHELL_URLS = [
  ...
  './src/bullets/berger-reverse/catalog.js',
  './src/bullets/sierra-reverse/catalog.js',
  './src/bullets/berger-published/catalog.js',
  './src/bullets/lapua-reverse/catalog.js',
  './src/rifles.js',
  ...
  './src/db-schema.js',
  './src/data-url.js',
  './src/sync/asset-cleanup.js',
  './src/sync/asset-state.js',
  './src/sync/device-deletion.js',
  './src/sync/duplicate-bundles.js',
  './src/sync/device-id.js',
  './src/sync/device-name.js',
  './src/sync/device-registry.js',
  './src/sync/backup-bundle.js',
  './src/sync/fs-folder.js',
  './src/sync/merge.js',
  './src/sync/revision.js',
  './src/sync/pending-review.js',
  './src/sync/disambiguate-by-name.js',
  './src/sync/write-hooks.js',
  './src/sync/sync-log.js',
  './src/sync/auto-sync.js',
  './src/sync/synced-libraries.js',
  ...
  './src/vendor/temml/temml.mjs',
  './src/vendor/temml/Temml-Local.css',
  './src/vendor/temml/Temml.woff2',
  ...
  './src/ui/rifle-cartridge-picker.js',
  './src/ui/collapsible-hint.js',
  './src/ui/section.js',
  './src/ui/backup-sync-settings.js',
  './src/ui/change-history-settings.js',
  ...
  './src/ui/arsenal/cartridge-precision-field.js',
  ...
  './src/views/rifle-precision-manual-view.js',
  './src/views/arsenal-manual-view.js',
  './src/views/bc-labradar-manual-view.js',
  './src/views/backup-sync-manual-view.js',
  './src/views/thanks-view.js',
  './src/views/release-history-view.js',
  './src/views/features-view.js',
  ...
  './src/manual/de.md',
  './src/manual/it.md',
  './src/manual/rifle-precision/en.md',
  './src/manual/rifle-precision/fr.md',
  './src/manual/rifle-precision/ru.md',
  './src/manual/rifle-precision/de.md',
  './src/manual/rifle-precision/it.md',
  './src/manual/arsenal/en.md',
  './src/manual/arsenal/fr.md',
  './src/manual/arsenal/ru.md',
  './src/manual/arsenal/de.md',
  './src/manual/arsenal/it.md',
  './src/manual/bc-labradar/en.md',
  './src/manual/bc-labradar/fr.md',
  './src/manual/bc-labradar/ru.md',
  './src/manual/bc-labradar/de.md',
  './src/manual/bc-labradar/it.md',
  './src/manual/backup-sync/en.md',
  './src/manual/backup-sync/fr.md',
  './src/manual/backup-sync/ru.md',
  './src/manual/backup-sync/de.md',
  './src/manual/backup-sync/it.md',
  './src/THANKS.md',
  './src/FEATURES.md',
  ...
  './src/targets/custom-target-render.js',
  './src/targets/circle-gong.json',
  './src/targets/circle-gong.js',
  './src/targets/circle-gong-thumb.svg',
  './src/targets/rect-plate.json',
  './src/targets/rect-plate.js',
  './src/targets/rect-plate-thumb.svg',
  ...
  './src/targets/ipsc-popper.json',
  './src/targets/ipsc-popper.js',
  './src/targets/ipsc-popper-thumb.svg',
  './src/targets/ipsc-popper-detail.svg',
  './src/targets/ipsc-popper-result.svg',
  './src/targets/ipsc-popper-mini.json',
  './src/targets/ipsc-popper-mini.js',
